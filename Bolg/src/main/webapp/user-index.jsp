...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <%--框架--%>
    <iframe name="userIframe" height="100%" width="100%" src="/user-report.jsp" frameborder="0" class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
··
    </iframe>
  </div>
</section>
        ...
        <div class="modal-body">
          ...
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="${user.userName}" class="form-control" name="userName" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">邮箱:</td>
                <td width="80%"><input type="text" value="${user.email}" class="form-control" name="email" maxlength="10" autocomplete="off" readonly/></td>
              </tr>
              <tr>
                <td wdith="20%">注册时间</td>
                <td width="80%"><input type="text" value="${user.registerTime}" readonly class="form-control" name="registerTime" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
                  <td wdith="20%">简介</td>
                  <td width="80%">
                      <textarea name="synopsis" placeholder="${user.synopsis}" class="form-control" rows="5"></textarea>
                  </td>
              </tr>
            </tbody>
            <tfoot>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="/assets/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="/assets/images/baoman/baoman_01.gif" alt="深思熟虑" />
